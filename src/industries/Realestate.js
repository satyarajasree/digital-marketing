...
import ChallengesImage from "../assets/real.webp";
import heroBg from "../assets/reall.webp";
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            <div className="flex justify-center mb-8">
              <div className="p-6 bg-white/10 rounded-3xl backdrop-blur-sm border border-white/20">
                <FaHome className="text-5xl text-blue-400" />
              </div>
            </div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
              Accelerate real estate growth with data-driven marketing
              strategies. Attract qualified buyers, boost property visibility,
              and build powerful real estate brands.
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
              {results.map((result, index) => (
                <div key={index} className="text-center group">
                  <div
                    className={`bg-gradient-to-r ${result.color} p-4 rounded-2xl inline-flex items-center justify-center mb-4 shadow-lg group-hover:scale-110 transition`}
                  >
          ...
          <div className="container mx-auto px-6 relative">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
                Specialized solutions for every segment of the real estate
                industry
              </p>
            </div>
                  ...
                  <div className="space-y-3">
                    {service.features.map((feature, i) => (
                      <div key={i} className="flex items-center">
                        <div className="bg-blue-500/20 p-1 rounded-lg mr-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white shadow-xl border border-gray-200 rounded-2xl p-6 hover:shadow-2xl transition">
                  ...
                  <p className="text-gray-600">
                    Use targeted ads, optimized listings, and high-intent lead
                    campaigns.
                  </p>
                </div>
                ...
                <div className="bg-white shadow-xl border border-gray-200 rounded-2xl p-6 hover:shadow-2xl transition">
                  ...
                  <p className="text-gray-600">
                    Improve SEO, strengthen brand presence, and showcase
                ...
                <div className="bg-white shadow-xl border border-gray-200 rounded-2xl p-6 hover:shadow-2xl transition">
                  ...
                  <p className="text-gray-600">
                    Use automated follow-ups, personalized messaging, and
                ...
                <div className="bg-white shadow-xl border border-gray-200 rounded-2xl p-6 hover:shadow-2xl transition">
                  ...
                  <p className="text-gray-600">
                    Run data-driven targeting, refine audience segments, and use
                    stronger filtering.
                  </p>
                </div>
              </div>
        ...
        <div className="py-24 bg-white">
          <div className="container mx-auto px-6">
            ...
            <h2 className="text-5xl font-bold text-gray-900 text-center mb-16">
              How{" "}
              <span className="bg-gradient-to-r from-cyan-500 to-blue-500 bg-clip-text text-transparent underline decoration-blue-400 decoration-4">
                Amplinova
              </span>{" "}
              turns that challenges into opportunity
            </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Low inquiries become a chance to refine targeting. By using
                  data-driven ads, buyer profiling, and optimized listings,
                  companies can attract more serious, high-quality leads.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Weak online visibility opens the door to build a powerful
                  digital brand. Improving SEO, running content marketing, and
                  showcasing projects with professional visuals boosts discovery
                  and trust.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Slow sales cycles can evolve into efficient conversion systems
                  through automated follow-ups, CRM integration, personalized
                  messaging, and virtual site visits.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Poor lead quality becomes an opportunity to refine targeting
                  strategies. Using demographic filters, buyer behavior
                  insights, and channel optimization ensures more relevant and
                  profitable leads.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-6 relative">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {segments.map((segment, index) => (
                <div
                  key={index}
                  className="bg-white rounded-2xl p-8 shadow-lg border border-cyan-100 hover:shadow-xl transition-all duration-300 group hover:border-cyan-300"
                >
        ...
        <div className="relative py-24 bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative z-10">
            ...
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
              Transform real estate marketing with analytics-driven strategies.
              Generate high-intent leads, maximize property reach, and elevate
              your brand presence.
            </p>
