...
const TestimonialsModern = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content:
        "Amplinova provided us with a comprehensive digital transformation solution that included LMS development, a modern website, and performance-driven marketing. Their structured approach and technical expertise resulted in increased student engagement and higher enrollment rates. They have proven to be a reliable and skilled technology partner.",
      rating: 5,
      image: "VD",
    },
    {
    ...
    },
    {
      ...
      content:
        "We always believed in the quality of our product, but our old packaging didn’t reflect it. Amplinova redesigned everything — from colors to typography to messaging. When we saw the new packaging, we knew our product finally had the identity it deserved.",
      rating: 5,
      image: "RK",
    },
  ];
  ...
  return (
    <section
      id="testimonials"
      className="pt-8 pb-20 bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-800 text-white overflow-hidden relative"
    >
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg%20viewBox%3D%220%200%20400%20400%22%20xmlns%3D%22http://www.w3.org/2000/svg%22%3E%3Cfilter%20id%3D%22noise%22%3E%3CfeTurbulence%20type%3D%22fractalNoise%22%20baseFrequency%3D%220.8%22%20numOctaves%3D%221%22%20stitchTiles%3D%22stitch%22/%3E%3C/filter%3E%3Crect%20width%3D%22100%25%22%20height%3D%22100%25%22%20filter%3D%22url(%23noise)%22%20opacity%3D%220.03%22/%3E%3C/svg%3E')] opacity-10" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="text-center mb-20">
            ...
            >
              Real results from Hyderabad's leading businesses who trusted us
              with their digital growth journey.
            </motion.p>
          </div>
            ...
            {testimonials.map((testimonial) => (
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 group-hover:border-amber-400/20 transition-all duration-500 overflow-hidden">
                  ...
                  {/* ⭐ UPDATED CONTENT WITH SEE MORE ⭐ */}
                  <div className="mb-6">
                    <p
                      className={`text-gray-200 text-lg leading-relaxed italic transition-all duration-300 ${
                    ...
                    <button
                      onClick={() =>
                        setExpanded(
                          expanded === testimonial.id ? null : testimonial.id
                        )
                      }
                      className="text-amber-400 mt-2 text-sm hover:underline"
                    >
