      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="h-1 bg-gradient-to-r from-blue-500 to-cyan-600 mx-auto mb-8 rounded-full"
          />
          ...
          >
            ...
            <span className="bg-gradient-to-r from-blue-400 to-cyan-600 bg-clip-text text-transparent font-semibold">
